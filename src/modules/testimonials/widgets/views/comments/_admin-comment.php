        ...
        <div class="panel-body">
            ...
            <div>
                ...
                <div class="pull-right">3
                    ...
                    <a href="<?=\yii\helpers\Url::to(['/testimonials/testimonial/delete','model_id'=>$model->id,'id'=>$item->comment->id])?>">Delete</a>
                </div>
            </div>
        </div>
    </div>
    <div class="margin">
        ...
        <div class="comments">
            ...
            <?php foreach ($item->children as $children): ?>
                <?php echo '--'; ?><?= $this->render('_admin-comment', ['item' => $children]) ?>
            <?php endforeach; ?>
        </div>
    </div>
</div>
